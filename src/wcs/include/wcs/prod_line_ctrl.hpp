...
private:
  ...
  rclcpp::Publisher<UInt8>::SharedPtr mtrl_box_amt_pub_;
  ...
  void mtrl_box_amt_container_cb();
  void mtrl_box_info_cb();
  ...
  const std::string healthy_               = "/healthy";
  ...
  const std::string packaging_info_        = "/packagingInfo";
  // const std::string order_completed_       = "/orderCompeleted";
  const std::string cleaning_mac_trig_      = "/cleaningMachineTrigger";
  ...
  // void order_completed_handler(const httplib::Request &req, httplib::Response &res);
  void cleaning_machine_trigger_handler(const httplib::Request &req, httplib::Response &res);
  ...
  const std::string materal_box_info_url_       = "/sort/materialBox/getMaterialBoxInfo";
  const std::string materal_box_info_by_id_url_ = "/sort/materialBox/getMaterialBoxInfoById";
  const std::string cells_info_by_id_url_       = "/sort/cell/getCellsInfoByMaterialBoxId";
  const std::string new_order_url_              = "/sort/order/newOrderFrom";
